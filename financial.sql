...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3789747657ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=financial&table=financial">`financial`.`financial`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=item_management&table=items">`item_management`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=customer&table=customer_details">`customer`.`customer_details`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="24583c5074632e41373c324c4a48214f">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="customer" targettable="customer_details">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `customer_details`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="customer" targettable="customer_details">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `customer_details`  
ORDER BY `customer_details`.`Occupation` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="customer" targettable="customer_details">
                            <div class="action_content">
...
ORDER BY `customer_details`.`Occupation` ASC</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `customer_details`  
ORDER BY `customer_details`.`Occupation`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="customer" targettable="customer_details">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `customer_details`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="item_management" targettable="items">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `items`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="financial" targettable="financial">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `financial`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="financial" targettable="financial">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `financial`(`BillID`, `BillDate`, `ConsumedUnits`, `UnitPrice`, `Toatal`) VALUES (&#039;1&#039;,&#039;2022/12/12&#039;,&#039;20&#039;,&#039;10.00&#039;,&#039;200&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="financial" targettable="financial">
                            <div class="action_content">
